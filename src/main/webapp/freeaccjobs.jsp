...
try {
    ...
    PreparedStatement statement = con.prepareStatement("SELECT * FROM applied where free_id in (select id from freelancer where user_id in(select user_id from users where email=?)) and status='accepted'");
