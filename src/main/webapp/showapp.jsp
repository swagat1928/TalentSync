...
try {
    ...
    PreparedStatement statement = con.prepareStatement("SELECT * FROM applied where client_id in (select id from client where user_id in(select user_id from users where email=?)) and status='pending'");
