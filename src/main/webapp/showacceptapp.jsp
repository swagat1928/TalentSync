...
try {
    ...
    PreparedStatement statement = con.prepareStatement("SELECT * FROM applied where client_id in (select id from client where user_id in(select user_id from users where email=?)) and status='accepted' and work_status='uncompleted'");
        ...
        <div class="col-sm-6 mb-3 mb-sm-0">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-text">Status : <%=rs.getString("status") %></p>
