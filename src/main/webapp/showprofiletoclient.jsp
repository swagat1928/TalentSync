...
ResultSet rs1 = null;
try {
	a =Integer.parseInt(request.getParameter("em"));
    Class.forName("com.mysql.jdbc.Driver");
    Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/freelance", "root", "100pushUPS!!!");
    PreparedStatement statement = con.prepareStatement("SELECT * FROM freelancer WHERE id=?");
    statement.setInt(1,a);
    rs = statement.executeQuery();
    
    PreparedStatement statement1 = con.prepareStatement("SELECT * FROM users WHERE user_id in(select user_id from freelancer where id=?) ");
